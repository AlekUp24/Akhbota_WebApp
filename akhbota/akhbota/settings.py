...
ALLOWED_HOSTS = ['akhbotawebapp-production.up.railway.app', 
                'www.akhbotawebapp-production.up.railway.app' , 
                '127.0.0.1', 
                'www.akhbota.eu' ,
                'akhbota.eu']
                
CSRF_TRUSTED_ORIGINS = ['https://akhbota.eu', 'https://www.akhbota.eu']
